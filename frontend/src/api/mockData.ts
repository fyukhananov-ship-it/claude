...
const OFFER_DEFS: OfferDef[] = [
  ...
  // Товары для дома / DIY
  ['Леруа Мерлен', 'Кэшбэк 8% в Леруа Мерлен', 'Дом и ремонт', 8, 'percent', 2000],
  ['OBI', 'Кэшбэк 10% в OBI', 'Дом и ремонт', 10, 'percent', 1500],
  ['Петрович', 'Кэшбэк 6% в Петровиче', 'Дом и ремонт', 6, 'percent', 3000],
  ['Максидом', '500₽ за покупку от 5000₽', 'Дом и ремонт', 500, 'fixed', 5000],
  ['Castorama', 'Кэшбэк 7% в Castorama', 'Дом и ремонт', 7, 'percent', 2000],

  // Одежда / обувь
  ['Lime', 'Кэшбэк 15% в Lime', 'Одежда и обувь', 15, 'percent', 1500],
  ['Gloria Jeans', 'Кэшбэк 12% в Gloria Jeans', 'Одежда и обувь', 12, 'percent', 1000],
  ['Zarina', 'Кэшбэк 10% в Zarina', 'Одежда и обувь', 10, 'percent', 2000],
  ['befree', 'Кэшбэк 14% в befree', 'Одежда и обувь', 14, 'percent', 1200],
  ['SELA', '500₽ за покупку от 3000₽', 'Одежда и обувь', 500, 'fixed', 3000],
  ['Rendez-Vous', 'Кэшбэк 8% в Rendez-Vous', 'Одежда и обувь', 8, 'percent', 3000],
  ...
  // QSR / фастфуд
  ['Вкусно — и точка', 'Кэшбэк 20% во Вкусно — и точка', 'Фастфуд', 20, 'percent', 200],
  ['Ростикс', 'Кэшбэк 15% в Ростикс', 'Фастфуд', 15, 'percent', 250],
  ['KFC', 'Кэшбэк 15% в KFC', 'Фастфуд', 15, 'percent', 300],
  ['Burger King', 'Кэшбэк 18% в Burger King', 'Фастфуд', 18, 'percent', 200],
  ['Subway', 'Кэшбэк 12% в Subway', 'Фастфуд', 12, 'percent', 300],
  ['Теремок', 'Кэшбэк 10% в Теремке', 'Фастфуд', 10, 'percent', 250],
  ...
  // Casual / fine dining
  ['Якитория', 'Кэшбэк 12% в Якитории', 'Рестораны', 12, 'percent', 1000],
  ['Тануки', 'Кэшбэк 10% в Тануки', 'Рестораны', 10, 'percent', 1200],
  ['IL Патио', 'Кэшбэк 15% в IL Патио', 'Рестораны', 15, 'percent', 800],
  ['Чайхона №1', 'Кэшбэк 8% в Чайхоне №1', 'Рестораны', 8, 'percent', 1500],
  ['Мясо&Рыба', 'Кэшбэк 10% в Мясо&Рыба', 'Рестораны', 10, 'percent', 2000],
  ...
  // Электроника / техника
  ['М.Видео', 'Кэшбэк 5% в М.Видео', 'Электроника', 5, 'percent', 5000],
  ['Эльдорадо', 'Кэшбэк 6% в Эльдорадо', 'Электроника', 6, 'percent', 3000],
  ['DNS', 'Кэшбэк 4% в DNS', 'Электроника', 4, 'percent', 5000],
  ['re:Store', 'Кэшбэк 3% в re:Store', 'Электроника', 3, 'percent', 10000],
  ['Ситилинк', 'Кэшбэк 5% в Ситилинке', 'Электроника', 5, 'percent', 3000],
  ...
  ['Литрес', 'Кэшбэк 25% на Литрес', 'Книги и хобби', 25, 'percent', 200],
  ['Читай-город', 'Кэшбэк 10% в Читай-городе', 'Книги и хобби', 10, 'percent', 500],
  ['Hobby Games', 'Кэшбэк 15% в Hobby Games', 'Книги и хобби', 15, 'percent', 500],
  ['Леонардо', 'Кэшбэк 8% в Леонардо', 'Книги и хобби', 8, 'percent', 800],
  ['Яндекс Плюс', '200₽ за подписку', 'Книги и хобби', 200, 'fixed', 300],

  // АЗС / топливо
  ['Лукойл', 'Кэшбэк 5% на АЗС Лукойл', 'АЗС', 5, 'percent', 1000],
  ['Газпромнефть', 'Кэшбэк 5% на АЗС Газпромнефть', 'АЗС', 5, 'percent', 1000],
  ['Роснефть', 'Кэшбэк 4% на АЗС Роснефть', 'АЗС', 4, 'percent', 1000],
  ['Shell', 'Кэшбэк 6% на АЗС Shell', 'АЗС', 6, 'percent', 1500],
  ['Татнефть', 'Кэшбэк 4% на АЗС Татнефть', 'АЗС', 4, 'percent', 800],
  ...
  ['Fix Price', 'Кэшбэк 10% в Fix Price', 'Магазины у дома', 10, 'percent', 300],
  ['Красное & Белое', 'Кэшбэк 5% в Красное & Белое', 'Магазины у дома', 5, 'percent', 500],
  ['Бристоль', 'Кэшбэк 7% в Бристоле', 'Магазины у дома', 7, 'percent', 400],
  ['Светофор', 'Кэшбэк 5% в Светофоре', 'Магазины у дома', 5, 'percent', 500],
  ['Верный', 'Кэшбэк 6% в Верном', 'Магазины у дома', 6, 'percent', 400],
  ...
  ['Яндекс Музыка', 'Кэшбэк 30% на Яндекс Музыку', 'Онлайн-сервисы', 30, 'percent', 200],
  ['VK Музыка', 'Кэшбэк 25% на VK Музыку', 'Онлайн-сервисы', 25, 'percent', 200],
  ['Skillbox', 'Кэшбэк 10% на Skillbox', 'Онлайн-сервисы', 10, 'percent', 5000],
  ['GeekBrains', 'Кэшбэк 8% на GeekBrains', 'Онлайн-сервисы', 8, 'percent', 5000],
  ['Нетология', 'Кэшбэк 12% на Нетологию', 'Онлайн-сервисы', 12, 'percent', 3000],
  ['МТС Музыка', 'Кэшбэк 20% на МТС Музыку', 'Онлайн-сервисы', 20, 'percent', 200],
]
